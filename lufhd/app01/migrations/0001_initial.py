# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-26 04:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Account', verbose_name='回答者')),
            ],
        ),
        migrations.CreateModel(
            name='AnswerComment',
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Account', verbose_name='评论者')),
                ('answer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Answer')),
                ('reply_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.AnswerComment', verbose_name='基于评论的评论')),
            ],
        ),
        migrations.CreateModel(
            name='Article',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.Account', verbose_name='使用者')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_recommend', models.BooleanField(default=False, verbose_name='热评推荐')),
                ('hide', models.BooleanField(default=False, verbose_name='不在前端页面显示此条评价')),
                ('course', models.ForeignKey(blank=True, help_text='不填写即代表评价整个学位课程', null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.Course', verbose_name='评价学位模块')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='my_students', to='app01.Account', verbose_name='导师')),
            ],
        ),
        migrations.CreateModel(
            name='Feedback',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homework', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Homework')),
                ('mentor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='my_stu_homework_record', to='app01.Account', verbose_name='导师')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.EnrolledDegreeCourse', verbose_name='学生')),
            ],
        ),
        migrations.CreateModel(
            name='Industry',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentors', models.ManyToManyField(to='app01.Account')),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
                ...
                ('account', models.ForeignKey(blank=True, help_text='不填用户的话代表给未注册用户发通知', null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.Account')),
                ('content_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('industry', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Industry')),
            ],
            options={
                'verbose_name': '职位信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Account', verbose_name='提问者')),
                ('course_section', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.CourseSection')),
                ('degree_course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.DegreeCourse')),
            ],
        ),
        migrations.CreateModel(
            name='Scholarship',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Account', verbose_name='被执行人')),
                ('content_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Course', verbose_name='学位模块')),
                ('enrolled_degree_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.EnrolledDegreeCourse')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachment_path', models.CharField(blank=True, help_text='跟进记录的截图等', max_length=128, null=True, verbose_name='附件路径')),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('enrolled_degree_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.EnrolledDegreeCourse', verbose_name='学生')),
                ('mentor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mentor', to='app01.Account', verbose_name='导师')),
            ],
        ),
        migrations.CreateModel(
            name='Tags',
        ...
        migrations.AddField(
            ...
            name='score_rule',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.ScoreRule', verbose_name='关联规则'),
        ),
        migrations.AddField(
            model_name='enrolleddegreecourse',
            name='order_detail',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app01.OrderDetail'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app01.EnrolledDegreeCourse'),
        ),
        migrations.AddField(
            model_name='degreecoursereview',
            name='enrolled_course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.EnrolledDegreeCourse'),
        ),
        migrations.AddField(
            model_name='degreecoursereview',
            name='tags',
        ...
        migrations.AddField(
            ...
            name='homework',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Homework'),
        ),
        migrations.AddField(
            model_name='courseschedule',
            name='study_record',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.StudyRecord'),
        ),
        migrations.AddField(
            model_name='coursereview',
            name='enrolled_course',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app01.EnrolledCourse'),
        ),
        migrations.AddField(
            model_name='coursereview',
            name='tags',
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.Order', verbose_name='关联订单'),
        ),
        migrations.AddField(
            model_name='city',
            name='province',
        ...
        migrations.AddField(
            ...
            name='course_section',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.CourseSection'),
        ),
        migrations.AddField(
            model_name='article',
            name='source',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.ArticleSource', verbose_name='来源'),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
        ...
        migrations.AddField(
            model_name='account',
            name='city',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.City', verbose_name='城市'),
        ),
        migrations.AddField(
            model_name='account',
            name='profession',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.Profession', verbose_name='职位信息'),
        ),
        migrations.AddField(
            model_name='account',
            name='tags',
            field=models.ManyToManyField(blank=True, to='app01.Tags', verbose_name='感兴趣的标签'),
        ),
        migrations.AlterUniqueTogether(
            name='studyrecord',
